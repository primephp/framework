...
class HTMLInputSelect extends HTMLInput {
     ...
     */
    public function addOptions(IListable $collection, $concat = false) {
        if ($collection instanceof IListable) {
    ...
    public function setSelected($selection) {
        ...
        if ($selection instanceof ArrayList) {
            $this->selection = $selection->getElements();
        }
    }
