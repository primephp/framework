...
class Upload {
    ...
    function Upload($file, $lang = 'en_GB') {
        ...
        $this->translation['already_exists'] = '%s já existe. Por favor mude o nome do arquivo.';
        $this->translation['copy_failed'] = 'Erro ao copiar o arquivo no servidor. copy() falhou.';
        $this->translation['create_error'] = 'Erro na criação da imagem %s a partir da fonte.';
        $this->translation['destination_dir'] = 'O diretório de destino não pode ser criado. Impossível continuar.';
        $this->translation['destination_dir_missing'] = 'O diretório de destino não existe. Impossível continuar.';
        $this->translation['destination_dir_write'] = 'Diretório de destino sem permissão para escrita. Impossível continuar.';
        $this->translation['destination_path_not_dir'] = 'O caminho especificado não é um diretório. Impossível continuar.';
        $this->translation['destination_path_write'] = 'O caminho de destino não tem permissão de escrita ou não pode ser aberto. Impossível continuar.';
        $this->translation['file_create'] = 'Criação de arquivos %s não suportada.';
        $this->translation['file_error'] = 'Erro na transferência. Por favor tente novamente.';
        $this->translation['file_not_uploaded'] = 'O arquivo não foi transferido. Impossível continuar.';
        $this->translation['file_too_big'] = 'Arquivo muito grande.';
        $this->translation['gd_missing'] = 'Biblioteca GD não parece estar presente.';
        $this->translation['image_too_high'] = 'A imagem é muito alta.';
        $this->translation['image_too_narrow'] = 'A imagem é muito estreita.';
        $this->translation['image_too_short'] = 'A imagem é muito curta.';
        $this->translation['image_too_wide'] = 'A imagem é muito larga.';
        $this->translation['incorrect_file'] = 'Tipo de arquivo incorreto.';
        $this->translation['local_file_missing'] = 'O arquivo local não existe.';
        $this->translation['local_file_not_readable'] = 'Não foi possível ler o arquivo local.';
        $this->translation['no_conversion_type'] = 'Tipo de conversão não foi definida.';
        $this->translation['no_create_support'] = 'Criação a partir do arquivo %s imposível...';
        $this->translation['no_mime'] = 'MIME type não detectado.';
        $this->translation['not_enough_pixels'] = 'A imagem tem poucos pixels.';
        $this->translation['ratio_too_high'] = 'A proporção da imagem é muito alta (Imagem muito larga).';
        $this->translation['ratio_too_low'] = 'A proporção da imagem é muito baixa (Imagem muito alta).';
        $this->translation['reading_failed'] = 'Erro ao ler o arquivo.';
        $this->translation['source_invalid'] = 'Impossível ler a fonte da imagem. É uma imagem?.';
        $this->translation['source_missing'] = 'O arquivo transferido esta incorreto. Impossível continuar.';
        $this->translation['source_not_readable'] = 'O arquivo fonte não é legível. Impossível continuar.';
        $this->translation['temp_file'] = 'Não foi possível criar o arquivo temporário. Impossível continuar.';
        $this->translation['temp_file_missing'] = 'O arquivo fonte é incorreto. Impossível continuar.';
        $this->translation['too_many_pixels'] = 'A imagem tem muitos pixels.';
        $this->translation['try_again'] = 'Erro ao carregar o arquivo. Favor tentar novamente.';
        $this->translation['uploaded_cant_write'] = 'Erro na transferência do arquivo (erro ao gravar o arquivo no disco).';
        $this->translation['uploaded_err_extension'] = 'Erro na transferência do arquivo (transferência do arquivo interrompida por uma extensão do PHP).';
        $this->translation['uploaded_missing'] = 'Erro ao carregar o arquivo (o arquivo não foi carregado).';
        $this->translation['uploaded_no_tmp_dir'] = 'Erro na transferência do arquivo (não foi possível localizar a pasta temporária).';
        $this->translation['uploaded_partial'] = 'Erro ao carregar o arquivo (o arquivo só foi carregado parcialmente).';
        $this->translation['uploaded_too_big_html'] = 'Erro ao carregar o arquivo (o arquivo carregado excede a diretiva MAX_FILE_SIZE especificado no formulário html).';
        $this->translation['uploaded_too_big_ini'] = 'Erro ao carregar o arquivo (o arquivo carregado excede a diretiva upload_max_filesize presente no php.ini).';
        $this->translation['uploaded_unknown'] = 'Erro ao carregar o arquivo (código de erro desconhecido).';
        $this->translation['watermark_create_error'] = 'Erro no momento da criação da marca d\'água %s a partir do arquivo fonte.';
        $this->translation['watermark_invalid'] = 'Impossível ler a marca d\'água, formato de arquivo desconhecido.';
        $this->translation['watermark_no_create_support'] = 'Criação a partir do arquivo %s impossível, marca d\'água não pode ser lida.';
        ...
        if ($this->lang != 'en_GB' && file_exists(dirname(__FILE__) . '/lang') && file_exists(dirname(__FILE__) . '/lang/class.upload.' . $lang . '.php')) {
            ...
            if (is_array($this->translation)) {
                $this->translation = array_merge($this->translation, $this->translation);
            } else {
                $this->lang = 'en_GB';
            }
        }
