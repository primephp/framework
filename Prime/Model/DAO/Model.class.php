...
use Prime\Model\Interfaces\IModel,
    ...
    Prime\Model\SQL\SQLDelete,
    Prime\Model\SQL\SQLExpression,
    Prime\Model\SQL\SQLFilter,
    Prime\Model\SQL\SQLInsert,
...
abstract class Model implements IModel {
    ...
    /**
     * 
     * @param \Prime\Model\SQL\SQLExpression $criteria
     * @return type
     */
    ...
    public function store() {
        if (empty($this->data[$this->getPrimaryKey()]) or
                (!$this->exist($this->data[$this->getPrimaryKey()])
                )) {
            $sql = $this->insert();
        } else {
            $sql = $this->update();
